        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full sevenimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">DIGITAL HEALTHCARE</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Care Experiences That Consumers Expect</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">In healthcare, meeting next-generation consumer expectations means delivering whole-person care and creating unified experiences, across physical, digital and stakeholder silos. To achieve success, Expert Digital Web helps organizations modernize foundational IT infrastructure and move to an ecosystem-based operating model that prioritizes collaboration, agility and resilience while delivering the care experiences that consumers demand—anytime, anywhere.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The healthcare segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Payers</h5>
                                        <p>Ready to deliver greater value? We help implement process improvements, increase innovation and prepare you for the future.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Pharmacy benefit managers</h5>
                                        <p>Our services include regulatory compliance solutions, clinical management programs, business intelligence systems and implementation advice.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Providers</h5>
                                        <p>Our innovative services and solutions help your organization deliver coordinated, quality care and improve financial performance.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
