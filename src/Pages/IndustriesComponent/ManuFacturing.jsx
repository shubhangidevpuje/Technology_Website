        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full elevenimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Making The Transition To Digital Manufacturing</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Analytics. Automation. Artificial intelligence. Smart factories. Integrated systems. With new digital skills and technologies, manufacturers can make business decisions based on real-time contextual data. It’s the biggest opportunity of the age, and we can help you make the transition.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>Ensuring optimal results from technology investments and digital programs</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>REACH compliance framework for chemical manufacturers</h5>
                                        <p>iREACH is Expert Digital Web proprietary solution to help process manufacturing clients attain compliance with the REACH (Registration, Evaluation, Authorization and Restriction of Chemicals) regulations of the European Union by building an information base from existing enterprise applications and guiding users through REACH stages with in-built configurable workflows.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
