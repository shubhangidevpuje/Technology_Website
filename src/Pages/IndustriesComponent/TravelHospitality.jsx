        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full fifteenimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">LOOKING AHEAD</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Reinventing The Customer Experience</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The travel & hospitality segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Travel suppliers & intermediaries</h5>
                                        <p>Innovate to gain market share. Better serve the connected customer as you control travel spend and costs.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Restaurants & food services</h5>
                                        <p>Strengthen your brand and engage your customers in new ways. Become more efficient and customer-centric.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Real estate & property services</h5>
                                        <p>Transform real estate services and deliver real value to your customers. Improve time to market and reduce costs.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
