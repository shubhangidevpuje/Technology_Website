        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full nineimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">REMAKING INSURANCE</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Digital Transformation Creates New Value</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">It’s an exciting time for the industry as more insurers invest to transform their business models. Because innovation is key to driving growth, we deliver insight that strengthens your digital presence, levels the field and achieves business vision.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Property & casualty</h5>
                                        <p>Streamline core processes and compete with digital startups. Simplify distribution, provide superior customer experiences and create lasting value.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Life & annuity</h5>
                                        <p>Make your operating model more efficient. Accelerate underwriting, speed products to market and satisfy customers with sophisticated digital tools.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
