        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full fourthimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">GENERATE RESULTS</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Engineer Data-Driven Experiences</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Is your data making money? By engineering personalized CX and streamlining operations, your organization can open new opportunities to monetize insights and deliver bottom-line results.Join our Aweso</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Partner with our team for software solutions that power smart networks, speed time to market and drive business-to-vertical industry capabilities.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Drive growth through optimized content value chains, superior experiences and maximized monetization opportunities.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Technology</h5>
                                        <p>Generate insights you can monetize. Partner with our team to modernize data and create platforms that deliver a compelling CX.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
