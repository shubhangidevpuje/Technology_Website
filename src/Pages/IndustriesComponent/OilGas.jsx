        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full twelthimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">UPSTREAM, MIDSTREAM, DOWNSTREAM SERVICES</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Digital Delivers More Energy Options</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">With the emergence of alternative energy sources and environmental concerns escalating, the oil and gas industry is turning to digital to deliver more energy options, reduce cost and provide higher customer satisfaction.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The oil & gas segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Upstream</h5>
                                        <p>Expert Digital Web upstream services unlock new business value while exceeding current operational needs.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Midstream</h5>
                                        <p>Our solutions leverage the latest digital capabilities, from remote surveillance to commodity trading analytics.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Downstream</h5>
                                        <p>Expert Digital Web digital offerings help refinery operators, distributors and retailers generate new value and growth.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
