        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full fifthimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">A NEW CONSUMER AGENDA</h3>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The consumer goods segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Apparel & footwear</h5>
                                        <p>Take advantage of solutions to improve sourcing, elevate label management, optimize pricing and boost business effectiveness</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Use digital technologies and strategies to drive innovation, revitalize product lines, and improve efficiencies and ROI.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Implement digital solutions to bring innovative products to market faster, more efficiently and at lower cost.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Food & beverage </h5>
                                        <p>Take advantage of fresh thinking to solve tough customer, supply chain and technology challenges.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Home & personal care</h5>
                                        <p>Leverage the latest cloud and software as a service (SaaS) solutions to capitalize on emerging new markets and changing customer expectations.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
