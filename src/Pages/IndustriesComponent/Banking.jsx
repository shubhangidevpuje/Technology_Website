        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full imgcontents" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">DIGITAL BANKING</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Putting The Focus On The Customer</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Maintaining your competitive advantage can be challenging when customers expect around-the-clock banking services. We help you streamline inefficient processes with strategies and solutions that grow your business and keep customers at the center of your organization.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The banking segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Retail and commercial banking</h5>
                                        <p>Rebuild technology and operating models for the future. Create next-gen experiences for corporate customers and end-to-end experiences for retail customers that deliver more efficient operations and payments processes.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Lending</h5>
                                        <p>Keep the human factor in your lending processes. Achieve scale and stability with automated front and back offices.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Payments</h5>
                                        <p>Modernize core processes. Our enterprise strategies and designs help you increase throughput and improve risk and fraud management.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
