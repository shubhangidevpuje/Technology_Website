        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full thirdimgcontents" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">TAILORED TRANSFORMATION</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Charting Your Digital Future</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">In a rapidly transforming industry and shifting regulatory landscape, how can capital markets firms gain flexibility to chart the right digital future? With transformation strategies tailored to your needs, we deliver solutions that deepen customer loyalty, drive long-term relationships and increase profitability</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The capital markets segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Our teams offer guidance in strategies and innovative solutions to address shifting investor demands.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Strategy and holistic end-to-end solutions for the digital future of investment.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Frameworks and solutions to address efficiency, regulatory and operational issues across the front, middle and back office, for the entire securities value chain.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Market information providers</h5>
                                        <p>Our expertise and partnerships enable providers to generate new insights for clients—and to monetize data for new revenue streams.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                        ...
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Exchanges</h5>
                                        <p>Enable technology and performance scalability, index operations and investor services.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
