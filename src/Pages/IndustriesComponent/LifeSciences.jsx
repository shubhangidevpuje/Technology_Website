        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full tenthimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">DIGITAL TRANSFORMATION </h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Accelerate Innovation In Life Sciences</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Driven by a vision to improve patient outcomes along with pressure to speed time to market, manage costs and navigate regulatory demands, life sciences companies have an urgent need to innovate. Integrating digital transformation into your business strategy drives results and creates a more intelligent, agile and high-performing enterprise.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The life sciences segments we serve</h3>
                            </div>
                        </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Implement digital strategies and operations to improve product development, speed to market and patient centricity for increased profitability.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Take advantage of intelligent digital platforms, cloud, data, automation and AI to develop safer, more effective and affordable drugs and improve patient outcomes.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
