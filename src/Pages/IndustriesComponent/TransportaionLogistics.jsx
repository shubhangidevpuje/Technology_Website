        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full fourtheenimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">DIGITAL INNOVATION</h3>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Harnessing the power of digital, transportation and logistics leaders are gaining better visibility of their supply chains, achieving real-time data access and speeding orders to customers everywhere. Leap ahead by applying the latest technologies such as IoT, machine learning, predictive analytics and blockchain.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The transportation & logistics segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Carriers</h5>
                                        <p>Streamline operations and improve supply chain visibility. Rethink asset utilization and shrink your environmental footprint</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Logistics providers</h5>
                                        <p>Optimize routes, boost productivity and surpass delivery benchmarks. Better compete against digital natives and industry giants.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Mail & express</h5>
                                        <p>Respond faster to changes, streamline back-office processes and leverage digital technology. Dial up the customer experience and increase trust.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
...
export default TransportaionLogistics;