        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full siximgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">EDUCATION 2.0</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Preparing The Future Workforce Through Blended Learning</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Digital-first connected learning paves the way to the future of higher education. Emerging technologies such as analytics, AI and machine learning will be key to hyper personalizing the student experience, helping to identify at-risk learners and provide the most effective support for each person.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Education providers</h5>
                                        <p>Expert Digital Web combines education sector domain knowledge with digital expertise to help schools, colleges and universities chart strategies and apply technology to improve student access, experiences and success. Our experience serving the broader education ecosystem make us uniquely positioned to help the education community navigate challenges such as declining enrollments, burdening fixed costs and re-imagining instructional technology.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Education publishers</h5>
                                        <p>Expert Digital Web works with the world’s top education publishers, helping them lead with digital-first products and content. We have proven experience transforming traditional businesses, products and operations designed for modern learning. Our services help improve profitability and de-risk investments in the platforms, products and programs offered by education publishers and enablers, alike.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Testing & assessment providers</h5>
                                        <p>Expert Digital Web industry leading design thinking and digital engineering services help build end-to-end platforms for assessment authoring, delivering, proctoring and reporting to enhance the classroom experience or certification in a professional environment. Cognizant partners with clients to drive new experiences and modernize applications and infrastructure to transform into modern, agile and scalable organizations.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
