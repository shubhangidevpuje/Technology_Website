        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full therteenimgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">DELIVER MODERN RETAIL EXPERIENCES</h3>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Digital Channels Deliver More Customers</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">The pace of change across retail is dramatic, with far more sales happening online. Cognizant research shows retailers with exceptionally strong revenue growth derive a higher percentage of sales from digital channels. The digital mandate is here and there is no time for delay.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>The retail segments we serve</h3>
                            </div>
                        </div>
                        <div className="grid-boxes">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Department stores</h5>
                                        <p>Maximize customer service and profits and meet changing demands amid increased competition and complex supply chains.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Discount stores</h5>
                                        <p>Optimize merchandising, increase supply chain efficiency and generate product mix forecasts for better retention.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        ...
                                        <p>Adjust prices, fine-tune inventory planning and deploy next generation point of sale systems to enhance the customer experience.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Specialty retailers</h5>
                                        <p>Embrace the future of shopping by delivering concepts and solutions for in-store selling through social networks.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
