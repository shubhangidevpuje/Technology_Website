        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full imgcontent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h3 className="h3">EMBRACE CHANGE</h3>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="elementor-widget-containerheading" style={{ fontSize: '3em' }}>
                                <p className="blacks">Expert Digital Web helps transform OEMs, suppliers, dealers and automotive finance companies into modern enterprises creating exceptional vehicles and experiences leveraging human-centered design, data driven intelligence and at-scale digital engineering.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="mx-auto col-md-8">
                            <div className="smallheading text-center mb-5">
                                ...
                                <h3>A wide range of digital solutions to speed products to market.</h3>
                            </div>
                        </div>
                        <div className="grid-boxes mx-auto justify-content-center">
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Product Engineering</h5>
                                        <p>In the design and engineering of new vehicles, we work with OEM engineering groups and Tier1 suppliers to conceptualize, design, develop and validate vehicle components and systems. Among our solutions are application/product lifecycle management (ALM/PLM) systems, which improve development and validation processes.</p>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Connected Vehicles</h5>
                                        <p>Our engineers leverage the experience gained from each of our client projects to your benefit. With connected vehicles, the development of embedded systems and IT system development are closely linked. Because we are knowledgeable in both areas, our vehicle networking solutions exceed exacting requirements in terms of data security.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Electric vehicle ecosystem</h5>
                                        <p>Expert Digital Web has been developing automotive software solutions for connected vehicles. Our engineers leverage the experience gained from each of our client projects to your benefit. With connected vehicles, the development of embedded systems and IT system development are closely linked</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Electrical and electronic systems</h5>
                                        <p>The future of modern automotive development is in electrical and electronic components. We handle all aspects of vehicle development—from car body, chassis and drive electronic system development to comprehensive development and integration of electric drive systems. Our specialties deliver positive outcomes in mobility, safety, comfort and functionality.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                    ...
                    <div className="row">
                        <div className="grid-boxes">
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Manufacturing and supply chain transformation</h5>
                                        <p>We help your business run its core processes smartly and efficiently. Among our success stories: implementing digital factory solutions to help prevent parts shortages in assembly line processes. We also transform legacy value streams for new product lines such as electric vehicles, while incorporating supply chain visibility and control tower.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                            ...
                            <div className="e-con-boxed">
                                <div className="e-con-inner">
                                    <div className="elementor-widget-containerheading">
                                        <h5>Cybersecurity</h5>
                                        <p>Expert Digital Web works with automotive enterprises around the world and has over two decades of experience in the security space. Many of our end-to-end security solutions leverage leading cloud platforms from our partners at AWS, Google and Microsoft. They provide a 360-degree view of your organization’s security ecosystem and holistically safeguard operations, factory floor and supply chain processes.</p>
                                    </div>
                                    <div className="mb-4 mt-5">
                                        <button href="/" className="elementor-buttons">Learn More</button>
                                    </div>
                ...
                <div class="container" style={{ marginBottom: '100px' }}>
                    <div class="row mx-auto ">
                        ...
                        <div class="col-md-12 flexwrap e-con-inner">
