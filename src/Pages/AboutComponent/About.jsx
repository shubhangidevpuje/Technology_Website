        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full aboutsection" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <div className="col-md-10" style={{fontSize:'50px',fontWeight:'bold'}}>Engineering Modern Business To Improve Everyday Lives</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '150px', marginTop: '5%' }}>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="elementor-widget-containerheading">
                                <h4 class="fs-4 fw-bold mb-3">Impact</h4>
                                <p >  Combining impact-focused strategy with client-centric design with technical mastery to delivery end-to-end projects</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="elementor-widget-containerheading">
                                <h4 class="fs-4 fw-bold mb-3">People</h4>
                                <p className="black">Using diversity and trust as the foundation to unlock our people's potential</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="elementor-widget-containerheading">
                                <h4 class="fs-4 fw-bold mb-3">Learning</h4>
                                <p className="black">Decentralizing the decision-making process and fostering entrepreneurship and autonomy to be able to adapt and learn fast.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-6">
                            <img width="650" height="501" src="https://expertdigitalweb.com/static/media/mission.44587b6cdc0f7157ae02.jpg" alt="Image not found" />
                        </div>
                        <div class="col-md-6">
                            <div class="Containerfeilds ps-md-5 ps-sm-0">
                                <div class="smallheading mb-4">
                                    <p>Our PROMISE</p>
                                    <h3>Turn Ideas into Reality </h3>
                                    <p style={{ fontWeight: 'normal', textTransform: 'none' }}>We pledge to challenge conventions, create experiences beyond expectation, and deliver outcomes unimagined, for our clients, their customers and staff. This promise is driven by four key ideas that help us back our words with action, and promote actual positive change for our people and planet</p><h3>Technology for Good</h3><p>No people-vs.-robots battle here. We believe the best experiences use technology to empower humans to do what they do best. With this approach, our people are free to follow their passions, focusing on quality, efficiency, and helping others—without wasting time on things that can be automated.</p>
                                </div>
                    ...
                    <div class="container-fluid">
                        <footer class="footerConatiner">
                            <div class="footer-top">
                                <div class="container">
                                    <div class="row mx-auto" style={{ marginleft: '15%', justifyContent: 'center' }}>
