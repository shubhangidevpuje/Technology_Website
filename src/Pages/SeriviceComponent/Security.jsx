        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full security" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Tackling Today's Top Security Challenges</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Security for the age of digital everything</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">Eliminate security blind spots and accelerate innovation, transformation and growth.</p>
                                <br />
                                <p className="black">Outdated security solutions. Sophisticated cyberthreats. Increasing compliance requirements. Faced with these and other security challenges, today’s companies need a proactive partner who can anticipate and neutralize threats before they materialize..</p>
                                <br />
                                <p className="black">At Expert Digital Web, we approach security as the starting point for delivering the outcomes that leading global organizations demand. Our end-to-end security solutions combine deep domain and industry expertise with a future-focused approach that encompasses advisory, transformation and managed services. We offer the foresight and expertise to solve your most complex challenges</p>
                                <br />
                                <p className="black">By providing a 360-degree view of your organization’s security ecosystem, Expert Digital Web can identify and eliminate today’s blind spots—while also seeing and solving for the threats ahead—so you can accelerate business innovation, transformation and growth.</p>
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <h3 className="h3">Secure your future</h3>
                                <h4>End-to-end security solutions</h4>
                                <p>Expert Digital Web end-to-end security solutions combine deep domain and industry expertise. Our future-focused approach gives you the confidence of a secure environment, so you can move faster, be bolder and succeed into the future.</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Threat and Vulnerability Management</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">With Expert Digital Web Security’s suite of Threat and Vulnerability Management services, you can test for and manage vulnerabilities across your network, systems and applications—helping you mitigate risk and improve resilience. Address today’s challenges and prepare for the future by identifying existing and emerging threats and vulnerabilities that could disrupt your journey.</p>
                                        </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">As you shift to a digital business model and expand your adoption of cloud, ensuring identities and controlling access have never been more important as legacy solutions become obsolete. With Expert Digital Web Security’s Identity and Access Management, you can deploy an agile solution that is highly scalable and hardens your cyber defenses</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Every day your company is generating vast amounts of data, and securing every bit of it is critical to the success of your organization. Our portfolio of trusted and scalable professional and managed data security services helps enterprises protect their critical data from cradle to grave in a cost-effective and compliant way with flexible, scalable and highly adaptable encryption and tokenization solutions.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Expanding digital enterprises face complex governance and compliance requirements. IT security risk is now a board-level concern, and meeting the minimum requirement is not enough. Expert Digital Web Security’s Governance, Risk and Compliance suite helps you assess current risks, verify adherence to standards</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Migrating workloads, applications and data to the cloud? The advantages are clear, but security is often overlooked. Understanding your risk and compliance requirements, as well as the implications to applications and identities, is critical. Expert Digital Web provides the expertise to help you minimize the risks of cloud migration.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
