        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full quality" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Putting Quality In The Fast Lane</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Rethink quality for digital</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">End-to-end quality assurance</p>
                                <br />
                                <p className="black">As enterprises simplify, modernize and secure their legacy environments for the digital era, robust quality assurance (QA) is essential. Quality takes an end-to-end connotation and must straddle both legacy and digital systems.</p>
                                <br />
                                <p className="black">Expert Digital Web Quality Engineering & Assurance (QE&A) is reimagining QA for you, employing an end-to-end ecosystem approach with intelligent and automated QA processes. In so doing, you gain quality and speed to promote faster business and technology change, as well as a better customer experience.</p>
                                <br />
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Business Change Assurance</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web connects QA outcomes closely to business outcomes by elevating QA from application quality to business process. Business process-aligned QA solutions, built on our industry knowledge and library of domain test assets, that address your business objectives.</p>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Technology Change Assurance</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">As technology comes front and center of every digital agenda, our end-to-end assurance solutions cover your entire digital technology stack—including social, mobile, analytics, cloud and IoT technologies—to ensure it plays well with your traditional enterprise technology stack</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Customer Experience Assurance</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Ensure unmatched customer experience for your applications through QA solutions that focus on performance, security and usability. We bring a 360-degree view of quality by complementing business and technology assurance with a CX focus.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Intelligent and Automated QA</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">At Expert Digital Web, we embed intelligence and automation as the core constructs of quality assurance, using cognitive capabilities and a lifecycle approach to automation.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
