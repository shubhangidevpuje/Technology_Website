            ...
            <div className="industries">
                        ...
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>How To Win At Digital Transformation</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>The right approach to digital strategy</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">As digital tools proliferate, so too do the number of customer demands and internal pressure to deliver digital-ready products and services.</p>
                                <br />
                                <p className="black">Implementing an effective digital strategy across front-, middle- and back-office IT environments is crucial to staying relevant. Yet, the urgent need to create and act on a digital strategy gives rise to a host of complex problems that enterprises must sort out quickly—or risk falling behind.</p>
                                <br />
                                <p className="black">We help clients set strategies in motion that unify business and technology architectures, generate growth and enable competitive advantage.</p>
                                <br />
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <h3>Leverage digital for transformative outcomes</h3>
                                <p>Accelerating the shift to digital with Expert Digital Web offerings makes the path clear and the process systematic. Our integrated digital solutions are custom-fit and empower clients to deliver game-changing impact.</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Insight Transformation</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Insight to Transformation creates a digital strategy that defines your trajectory for transformation and accelerates value creation. We have re-envisioned the strategy process from a digitally native perspective to gain velocity and deliver a game-changing strategy</p>
                                        </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">To keep up with the digital revolution, many companies are investing in technology to drive transformation. However, progress can be slow. Expert Digital Web Change Adoption offerings provide a comprehensive digital strategy for implementing large-scale transformation at scale. Using digital tools to expedite adoption and agility.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Transformation Enablement</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Leveraging deep experience in the management of complex business and IT transformations, our skilled practitioners establish the strategy, structure, roadmap, controls and governance needed to move forward with confidence. We also equip leadership with the latest visual tools to adjust quickly to future shifts and changes in demand.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
