        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full artifialintelligence" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Release Data’s Value With AI</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12"><div style={{ fontSize: '2.8em' }}>
                            <p className="black">When an opportunity or threat arises, businesses must act instantly and decisively to ensure success. A modern, AI-ready data strategy can drive intelligent decision-making and reveal what happened and why, so you can look ahead and get viable options for moving forward. That’s the power of intuition engineered fueled by the latest AI capabilities.</p>
                        </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Our organization has been building data for months, years or even decades. Now, as new digital touch points pop up with growing regularity, businesses are swimming in actionable information. Find out how you can put this information to work, to get answers and insights that can help your business predict and act. </p>
                                        </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Business leaders start by understanding what they want to make happen and then do so by understanding what is happening, why it happened and what will happen next, to determine the next critical actions to take to optimize business outcomes.Let us help your business innovate beyond insights.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>The AI-Driven Company</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Watch how evolutionary AI™ helps business leaders quickly understand what’s happening, why it happened and respond proactively to stay ahead. Evolutionary AI augments decision making, identifies problems and uncovers opportunities and Choose from multiple strategies.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Gain the strategic perspective of our consulting team to solve your most complex business problems, at any stage in your digital transformation. We can create data strategies that drive tangible business outcomes and build roadmaps that deliver a competitive advantage.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
...
export default ArtifialIntelligence;