        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full coremodernization" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Zero Maintenance Apps That Run On Autopilot</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Transform for digital</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">How do you cost-effectively prepare your IT environment to predict and meet business needs of today and tomorrow?</p>
                                <br />
                                <p className="black">How does your business meet the ever-expanding expectations of today’s customers? Turn to Cognizant. We’ll help you reimagine and modernize your core applications and IT infrastructure to meet your business’s increasing demands—all while ensuring the highest levels of security.</p>
                                <br />
                                <p className="black">We leverage our deep understanding of modern technologies, applications, infrastructure, security, operations, industry domains and human-centric design to mitigate transformation risks as you build for the future. In addition, we envision and deploy simple and elegant solutions, transforming and streamlining applications and infrastructure at speed and scale—all to help you deliver on the promise of digital for your business and drive growth.</p>
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Modernize infrastructure</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Migrate your IT environment to better support legacy and new applications, including new functionality to meet business needs, retain value from existing investments and minimize costs—both today and tomorrow.</p>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Manage your application stack</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">We leverage automation to modernize workspace technologies. Our cloud-first approach helps you rethink how to optimize enterprise IT, including infrastructure fundamentals: compute storage, network and data center strategies.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Redesign Core Applications</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web Softvision offers today’s most comprehensive software engineering expertise for building new products and experiences, transforming legacy application for cloud and modernizing core infrastructure and platforms.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Tighten Enterprise Security</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Outdated security solutions. Sophisticated cyber-threats. Increasing compliance. For these and other security challenges, team up with a proactive partner who can anticipate and neutralize threats before they materialize.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
...
export default CoreModernization;