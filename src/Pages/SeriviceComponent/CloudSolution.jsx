        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full cloudsolution" >
                        <div className="container">
                            <div className="listul">
                              ...
                              <h2 className="h2">COGNIZANT CLOUD</h2>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Innovate With Cloud Solutions</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Outcome-based cloud business solutions</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">Cloud solutions are the fastest and most effective way to innovate and run your business today. Respond and adapt immediately to changes in your industry with real-time reporting and customized, buyer-focused user experiences.</p>
                                <br />
                                <p className="black">Move processing power exactly where it’s needed by bringing all your IT resources into one secure cloud solution platform.</p>
                                <br />
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <h3>Drive digital CX and business outcomes </h3>
                                <p>We engineer applications for modern businesses. We help organizations deliver maximum digital value and unleash an unbeatable competitive advantage by leveraging modern software engineering principles, homegrown platforms, deep industry expertise and strategic partnership networks.</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Core Infrastructure Management</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Large enterprises need to make their IT infrastructure and processes cloud ready today to reap the full benefits tomorrow. Core Infrastructure Management (CIM) is a broad offering that enables businesses to extract value from existing systems by modernizing technology, reimagining processes and transforming user experiences. From networking to data-center consolidation and hybrid cloud implementations, CIM encompasses a complete “cloud-smart” strategy. An agile IT infrastructure enables you to scale and adapt to changing needs.</p>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Cloud Infrastructure Modernization and Management</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web industry experience and expertise across critical platforms makes us the trusted digital partner to drive and deliver results.CIMM combines market-leading talent, innovative methods, IP and thought leadership to enable industry-focused business outcomes and user engagement. Cloud-driven business transformation is not only central to Cognizant’s approach but also to your ability to adapt and succeed in dynamic markets. Starting with a modern infrastructure, we simplify and recalibrate cloud strategies to maximize outcomes for our clients.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Expert Digital Web WorkNext Digital Workplace Services accelerate the move from traditional work environments to a completely modern workplace. Onboarding new users is quick and intelligent with self-healing software and adoptive self-service capabilities. Drive innovation in your business by tapping our extensive background in cloud workplace, AI/ML, analytics, modern collaboration, platform integrations and automation.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
