        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full digitalexperience" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Exceptional CX Starts With Your Employees</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Exceptional CX starts with your employees</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">Delivering tomorrow's experiences today</p>
                                <br />
                                <p className="black">Great experiences are determined by the sum of all interactions that customers and employees have with a brand over time.</p>
                                <br />
                                <p className="black">Our experts draw on strategy and research to link data to design, systems to stories and insights to outcomes. We unearth moments that matter most in customer and employee journeys and orchestrate software, platforms, and programs to transform these high-value interactions into personalized experiences that drive business results.</p>
                                <br />
                                <p className="blacck">Expert Digital Web Digital Experience ultimately connects people with extraordinary experiences. We unlock these experiences with a range of offerings.</p>
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <h3>Experience-led solutions</h3>
                                <p>Our experience-led offerings traverse the entire customer life cycle and drive value across industries. We help the world’s biggest corporations work better to: Understand their customers, Enable their employees, Scale personalized, relevant and valuable experiences</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Customer and employee experience</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Experience has become more important than price or product. Put simply, experience is everything if you want to turn customers and employees into loyal brand champions. To deliver experiences that differentiate, businesses need to keep up with continuously evolving expectations. How? Staying on top of their customer data and market context to understand what’s driving human behavior. This understanding allows businesses to engage in meaningful interactions with customers and employees alike. Employees feel empowered and rewarded and in turn, will support exceptional customer experiences.</p>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Content and Marketing Services</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Every interaction a brand has with a customer or employee is an opportunity to develop a relationship. Those opportunities are won or lost depending on a company’s ability to connect with audiences through content that is relevant, timely and compelling. Making connections that last requires organizations to personalize content and determine the channels where customers want to receive those messages. To scale this personalization, enterprises must successfully orchestrate people, creativity, data, insights and technology, all while optimizing content creation and delivery through a global operating model.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Consumers expect personalized experiences that help them meet their needs quickly and intuitively. In retail or insurance, healthcare or travel, or even industrial machinery—consumers look for personalized and seamless interactions regardless of channel. Managing larger transaction volumes and more complex individual needs means companies must approach omnichannel commerce with new thinking and new capabilities. Expert Digital Web can help you create intuitive experiences that drive brand engagement and convert shoppers into long-term customers.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
