        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full infastructure" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Be A Modern Business With An Always-On Infrastructure</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                ...
                                <p>Business demands keep changing—which means your infrastructure must do more to stay ahead of the competitive curve. Expert Digital Web Cloud and Infrastructure Services keeps your business always ready, powers up employee productivity, integrates your departments and groups, and future-proofs your organization.</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Digital Workflow and Experience Services</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Harnessing all that ServiceNow offers requires a fresh, strategic, knowledgeable approach to business modernization. Cognizant’s consultative approach helps you to create digital workflows based on the power and flexibility of the Now platform®—and to run them at scale across your entire organization.</p>
                                        </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">WorkNEXT, Expert Digital Web digital workplace solutions suite, delivers personalized, seamless experiences for your employees anywhere, anytime, on any device. In addition to leveraging AI, analytics and automation, our solutions also: Enable remote collaboration with flexible working models</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">With ever-increasing, real-time data generation, processing and consumption at the edge of the enterprise, leading companies are building edge-to-core infrastructure services with an outside-in view. Expert Digital Web Edge Services offers managed edge-to-core computing</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">As the volume and velocity of data and interactions continue to increase, the departments and groups in your organization must be integrated. Service management and artificial intelligence (AI) need to be enabled to offer seamless and intelligent services.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Expert Digital Web Hybrid Cloud offering provides a comprehensive portfolio of services covering design, build, migrate and operate across private and public cloud environments. It establishes the foundation for digital-ready operations by transforming legacy IT to a future-ready as-a-service delivery model.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
