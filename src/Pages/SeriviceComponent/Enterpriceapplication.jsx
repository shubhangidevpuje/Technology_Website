        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full enterprise" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Where Digital Transformation Meets Business Agility</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Your partner for digital orchestration</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">Winning the customer battle in the digital economy</p>
                                <br />
                                <p className="black">Winning in the digital age takes more than just a strong customer experience. Your CX must be highly relevant and directly connected with the rest of your value chain. You must break down organizational silos in the way you engage with customers, employees and partners.</p>
                                <br />
                                <p className="black">Expert Digital Web Enterprise Application Services (EAS) help clients across industries reimagine their digital CX, attract and retain a world-class workforce, engage their partner ecosystems more productively, and run their operations and financial organizations more efficiently.</p>
                                <br />
                                <p className="black">By building a simpler, modernized landscape, Expert Digital Web EAS can help you transform your business, achieve your key business goals—and win in the digital economy.</p>
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <h3>End-to-end application services</h3>
                                <h4>A world-class portfolio of EAS solutions</h4>
                                <p>Your enterprise applications are at the core of your organization’s IT structure. Expert Digital Web EAS help you digitally transform multiple front- and back-office business processes, including CX/CRM, HCM, SCM and finance/ERP.</p>
                            </div>
                        </div>
                    </div>
                    <div class="elementor-elementSecond">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        <div class="elementor-icon-box-icon">
                                            <span class="elementor-animation">
                                                <svg viewBox="0 0 70 70" space="preserve">
                                                    <circle cx="38.8" cy="37.7" r="31.2" style={{ fill: 'rgb(255, 216, 0)' }}></circle>
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Customer Service Transformation</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web Customer Service Transformation is a comprehensive approach that helps organizations deliver personalized, streamlined and effective experiences that meet ever-evolving customer expectations. Now, businesses can cater to each customer through their trusted channels and create memorable brand interactions at each step.</p>
                                        </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Evolving workforce demographics. Complex HR business context. Mergers and acquisitions. Ever-changing regulations. Together, these factors create a dynamic shift in HCM and change HR business expectations.The combination of our HCM domain expertise and digital HR offerings gives you a structured roadmap for end-to-end digital HR transformation.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Digital Supply Chain Transformation</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">The COVID-19 pandemic, wars, trade embargos, shifting financial conditions and interdependent businesses prompt organizations to look beyond traditional supply chain processes to deliver value to the enterprise. Expert Digital Web Supply Chain Management practice offers high-performance supply chain solutions enabled by next-generation technologies that modernize your operations while reducing costs</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Finance/ERP/EPM</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Inconsistent markets. Changing regional regulatory and statutory requirements. Rapid technology developments. Each of these factors requires finance to continually assess and redesign business strategy to remain competitive. We understand your complex finance environment, and we deliver the solutions you need to transform it—from platform-anchored and cross-platform solutions.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
