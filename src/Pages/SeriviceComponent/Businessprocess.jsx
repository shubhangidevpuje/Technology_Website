        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full businessprocess" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <h2 className="h2">OPERATE WITH INSIGHT AND SPEED</h2>
                                <div className="d-md-flex justify-content-between align-items-end">
                                    <h1>Business Intuition To Supercharge Performance</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Accelerate through uncertainty</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">Turbulent times create opportunities for bold enterprises to leapfrog the competition by making strategic moves when others wait out the storm.</p>
                                <br />
                                <p className="black">Let's collaborate and accelerate through uncertainty with confidence. We can help your organization anticipate what's next, quickly act on emerging trends and self-fund growth through efficiency..</p>
                                <br />
                                <p className="black">Together we’ll simplify processes, increase productivity, harness the power of data and ingenuity and scale new ideas—fast. That’s intuition engineered..</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR MODERN SERVICES</p>
                                <h3>BPS and automation services</h3>
                                <p>As a business operations partner to some of the largest digital pioneers in the world, we operate at the frontier of the new. We combine our  distinctive expertise in powering modern operating models with industry depth and our leadership in process and IT automation to help your  business transform operations, stay relevant and thrive</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Stay ahead of the curve by building business-centric, tailored application portfolios with cutting-edge technologies through Expert Digital Web Smart Engineering platform </p>
                                        </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Modernize applications, improve technical value, harness cloud-based development and develop your digital portfolio with our Expert Digital Web Modernization Acceleration Platform </p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Achieve the hyper-industrialization of application management and reduce operational expenses by up to 50% through intelligent automation and our proprietary, platform-based debt management strategy to fund modernization initiatives.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Expert Digital Web Applens</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web AppLens is an AI-based platform that uses intelligent, data-driven and context-based solutions to enable you to drive your application strategy end-to-end, increasing the lifespan and yield of your applications.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Expert Digital Web Lifecycle Engineering Acceleration Platform</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web Lifecycle Engineering Acceleration Platform is an AI-powered BOT-based platform that uses AI, ML and NLP techniques, and brings years of business, technology, functional experience and new technology archetypes to your development toolchain..</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Expert Digital Web Modernization Acceleration Platform</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web Modernization Acceleration Platform is a unified and comprehensive platform that defines and orchestrates your modernization strategy and execution by leveraging proprietary IPs and partner tools across the modernization lifecycle.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Expert Digital Web Business Outcomes &amp; Experience Dashboard</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">A customizable, single source of truth to improve business outcomes, Expert Digital Web Business Outcomes &amp; Experience Dashboard  provides visibility into the health of your business processes using full-stack observability.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
