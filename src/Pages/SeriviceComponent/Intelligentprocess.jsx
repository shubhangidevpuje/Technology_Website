        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full intelligent" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Turn Automation Advantage Into Human Advantage</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>IPA: The future is now</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">Yesterday’s operating model won’t deliver tomorrow’s wins. Connect your processes, people and insights across the enterprise with intelligent process automation (IPA) for breakthrough performance at lower costs.</p>
                                <br />
                                <p className="black">Our experts partner with you to design new ways of working that maximize the potential of automation. Together, we reimagine processes with human and digital intelligence to accelerate transformation and help your business sense the future.</p>
                                <br />
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <h3>Work intelligently, unleash potential</h3>
                                <p>Expert Digital Web Intelligent Process Automation practice combines advisory services with deep vendor partnerships and integrated solutions to create and execute strategic roadmaps. We begin where you are in your automation journey and help you accelerate your pace of adoption, embedding our teams directly into your culture to deliver results.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Expert Digital Web Solutions</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Achieving maximum business results with intelligent process automation requires enterprise-wide digital operations using technology that’s uniquely designed for your IT ecosystem. Our proprietary and partner solutions help you simplify, accelerate and expand automation—enabling end-to-end processes to create flexible, resilient operating models.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
...
export default Intelligentprocess;