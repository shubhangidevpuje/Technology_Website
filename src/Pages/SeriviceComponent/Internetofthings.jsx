        ...
        <>
            <div className="industries">
                ...
                <div className="container-fluid" style={{ marginBottom: '130px' }}>
                    <div className="e-conn-full internet" >
                        <div className="container">
                            <div className="listul">
                                ...
                                <div className="col-md-12 d-md-flex justify-content-between align-items-end">
                                    <h1>Simplifying IoT At Scale</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style={{ marginBottom: '130px' }}>
                    <div class="align-items-center row">
                        <div class="col-md-12">
                            <h2 style={{ fontWeight: 'bold', fontSize: '3em' }}>Fusing physical and digital</h2>
                            <br />
                            <div style={{ fontSize: '1.4em' }}>
                                <p className="black">IoT technologies fuse the physical and digital worlds, connecting enterprises, extracting intelligence and propelling autonomy. Then you can focus on driving revenue and improving sustainability and market leadership.</p>
                                <br />
                                <p className="black">The convergence of digital and physical is creating new market opportunities. But it’s also presenting new business challenges. At Expert Digital Web, we help businesses modernize quickly to anticipate customer and market demands and act instantaneously.</p>
                                <br />
                                <p className="black">By connecting spaces, products, industrial manufacturing and modern mobility, our engineers provide IoT platforms to help you re-invent your operations, build innovative experiences and create your next-generation products. The results: sustainable revenue growth, optimized margins and improved valuations.</p>
                                <br />
                    ...
                    <div class="row">
                        <div class="mx-auto col-md-7">
                            <div class="smallheading text-center mb-5">
                                <p>OUR OFFERINGS</p>
                                <p>We use a human-centric approach to solve your biggest challenges and improve everyday life. Across information and operational technology, we combine software, hardware and edge IoT technologies with engineering and security capabilities to help your business take advantage of the almost unlimited synergies between the physical and digital worlds.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            ...
                                            <p class="elementor-icon-box-description">Smart connectivity extends the functionality of consumer, medical and industrial devices, creating new revenue streams while streamlining processes and delivering better experiences.</p>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>IoT Operations</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">We develop smart solutions that transform industrial and production supply chains and operations, helping to reduce costs and accelerating time to market.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>IoT Mobility</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Intelligent solutions enable connected, shared and autonomous mobility in transportation and logistics, driving better efficiencies across the business ecosystem.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>IoT Spaces</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Connected solutions create intelligence across public and private buildings, factories and other related infrastructure, elevating experiences and driving sustainability.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="elementor-widget-container p-4">
                                    <div class="elementor-icon-box-wrapper">
                                        ...
                                        <div class="elementor-icon-box-content">
                                            <h5 class="elementor-icon-box-title">
                                                <span>Expert Digital Web Sustainability Services</span>
                                            </h5>
                                            <p class="elementor-icon-box-description">Expert Digital Web is committed to helping companies get to net-zero and meet sustainability goals. Our solutions enable you to take action on core business-related changes involving products, supply chain, operations and real estate functions.</p>
                                        </div>
                                        <button>Learn More</button>
                                    </div>
                                </div>
